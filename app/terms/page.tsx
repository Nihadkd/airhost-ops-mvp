...
export const metadata: Metadata = buildMetadata({
  title: "Vilkar | ServNest",
  description: "Les brukervilkar for ServNest, inkludert regler for konto, oppdrag, betaling og bruk av plattformen.",
  path: "/terms",
  keywords: ["vilkar", "brukervilkar", "ServNest vilkar"],
});
  ...
  return (
    <main className="mx-auto mt-10 w-[95%] max-w-3xl">
      <section className="panel p-6">
        <h1 className="text-2xl font-bold">Brukervilkar for ServNest</h1>
        ...
        <section className="mt-5 space-y-3 text-sm leading-6">
          ...
          <p>Vilkrene kan oppdateres. Vesentlige endringer varsles i tjenesten.</p>

          <h2 className="text-lg font-semibold">9. Lovvalg og tvister</h2>
          <p>Vilkrene reguleres av norsk rett. Tvister sokes lost i minnelighet for eventuell domstolsbehandling.</p>
