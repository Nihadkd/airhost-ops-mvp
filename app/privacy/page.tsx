...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Les hvordan ServNest behandler personopplysninger, lagrer data og ivaretar sikkerhet og personvern.",
  path: "/privacy",
  keywords: ["personvern", "privacy", "data", "ServNest personvern"],
});
    ...
    <main className="mx-auto mt-10 w-[95%] max-w-3xl">
      <section className="panel p-6">
        ...
        <section className="mt-5 space-y-3 text-sm leading-6">
          ...
          <p>Du kan be om innsyn, retting, sletting, begrensning, dataportabilitet og protest i trad med gjeldende regelverk.</p>
